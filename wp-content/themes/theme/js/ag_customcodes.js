     ...
     tinymce.create('tinymce.plugins.posts', {  
        init : function(ed, url) {  
            ed.addButton('posts', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[posts number="4" category="" content="yes" title="Latest Posts." type="post"]' + ed.selection.getContent() + '[/posts]');  
   ...
   ////////////////////
    ...
    tinymce.create('tinymce.plugins.slider', {  
        init : function(ed, url) {  
            ed.addButton('slider', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[slider crop="yes" slide1="Enter an Image URL" slide2="Enter an Image URL" slide3="Enter an Image URL"]' + ed.selection.getContent() + '[/slider]');  
    ...
    tinymce.create('tinymce.plugins.toggle', {  
        init : function(ed, url) {  
            ed.addButton('toggle', {  
                title : 'Add a toggle',  
                image : url+'/buttons/toggle.gif',  
                onclick : function() {  
                     ed.selection.setContent('[toggle title="Click Me To Toggle" class=""]Content' + ed.selection.getContent() + '[/toggle]');  
    ...
    tinymce.create('tinymce.plugins.accordion', {  
        init : function(ed, url) {  
            ed.addButton('accordion', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[accordion class=""]<br />[accordion_section title="Title"]Content' + ed.selection.getContent() + '[/accordion_section]<br />[accordion_section title="Title"]Content[/accordion_section]<br />[accordion_section title="Title"]Content[/accordion_section]<br />[/accordion]');  
    ...
    tinymce.create('tinymce.plugins.pricing', {  
        init : function(ed, url) {  
            ed.addButton('pricing', {  
                ...
                image : url+'/buttons/pricing.gif',  
                onclick : function() {  
                     ed.selection.setContent('[pricing_table class=""]<br />[pricing size="one_half" featured="no" plan="Basic" cost="$20" per="month" button_url="#" button_text="Purchase" button_target="self" class=""]<ul><li>Feature</li><li>Feature</li><li>Feature</li></ul>' + ed.selection.getContent() + '[/pricing]<br />[pricing size="one_half" position="last" featured="yes" plan="Advanced" cost="$20" per="month" button_url="#" button_text="Purchase" button_target="self" class=""]<ul><li>Feature</li><li>Feature</li><li>Feature</li></ul>[/pricing]<br />[/pricing_table]');  
    ...
    tinymce.create('tinymce.plugins.social', {  
        init : function(ed, url) {  
            ed.addButton('social', {  
                title : 'Add a social icon',  
                image : url+'/buttons/social.gif',  
                onclick : function() {  
                     ed.selection.setContent('[social icon="twitter" url="http://twitter.com" title="Follow Us"]' + ed.selection.getContent() + '[/social]');  
