...
<li <?php echo ($ag_slide['transition']) ? 'data-transition="' . $ag_slide['transition'] .'"' : 'data-transition="fade"' ?> data-slotamount="7" <?php echo ($ag_slide['slide_link']) ? 'data-link="' . ag_addhttp($ag_slide['slide_link'] && $ag_slide['slide_link'] != '') .'"' : '' ?> class="<?php echo 'slide-' . get_the_ID(); ?>">
    ...
    <div class="caption sfl homeheadline vcenter leftside" data-x="50" data-y="<?php echo $ag_slide['caption_height']; ?>" data-speed="1200" data-start="700" data-easing="easeOutCubic"><div class="clear"></div>
    ...
    <!-- Slide Video -->
    <div class="caption sfl homeimage vcenter rightside media" data-x="500" data-y="<?php echo $ag_slide['caption_height']; ?>" data-speed="1200" data-start="1200" data-easing="easeOutCubic">
