...
<!-- Slide -->
<li <?php echo ($ag_slide['transition']) ? 'data-transition="' . $ag_slide['transition'] .'"' : 'data-transition="fade"' ?> data-slotamount="7" <?php echo ($ag_slide['slide_link']) ? 'data-link="' . ag_addhttp($ag_slide['slide_link'] && $ag_slide['slide_link'] != '') .'"' : '' ?> class="<?php echo 'slide-' . get_the_ID(); ?>">
    ...
    <!-- Slide Video -->
	<div class="caption sfr homeimage vcenter leftside media" data-x="0" data-y="<?php echo $ag_slide['caption_height']; ?>" data-speed="1200" data-start="700" data-easing="easeOutCubic">
		<div class="homeimageinner vcenter">
    ...
    <div class="caption sfr homeheadline rightside vcenter" data-x="525" data-y="<?php echo $ag_slide['caption_height']; ?>" data-speed="1200" data-start="<?php echo (has_post_thumbnail() || ($ag_slide['video'] && $ag_slide['video'] != '')) ? '1200' : '700'; ?>" data-easing="easeOutCubic"><div class="clear"></div>
		<div class="homecaption vcenter <?php echo ($ag_slide['caption_bg_color'] == '') ? 'nobg' : '';?>">
            ...
            <h2 <?php echo ($ag_slide['caption_color']) ? 'class="' . $ag_slide['caption_color'] .'"' : '' ?>>
            	<span <?php echo ($ag_slide['caption_bg_color']) ? ag_hex2rgba($ag_slide['caption_bg_color'], '0.75') : '';?>>
					<?php the_title(); ?>
                </span>
            </h2>
            <?php endif; ?>
